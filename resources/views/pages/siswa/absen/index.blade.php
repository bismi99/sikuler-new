                ...
                <table class="tg table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="tg-3xi5">{{ $absen->jadwal['mapel']['kode'] }}</td>
                            <td class="tg-3xi5">{{ $absen->jadwal['mapel']['mapel'] }}</td>
                            ...
                            <td class="tg-3xi5">
                                {{number_format((($absen->p1 + $absen->p2 + $absen->p3 + $absen->p4 + $absen->p5 + $absen->p6 + $absen->p7 + $absen->p8 + $absen->p9 + $absen->p10 + $absen->p11 + $absen->p12 + $absen->p13 + $absen->p14 + $absen->p15 + $absen->p16 + $absen->p17 + $absen->p18) / 36) * 100 , 2)}}%
                            </td>
                        </tr>
                        @empty
                        <tr>

...
<div id="absen">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h4 class="text-success">Absensi Tahun Akademik: {{$ta->tahunakademik}}/{{$ta->semester}}</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-12">
                <a type="submit" href="#" target="_blank" class="btn btn-success mt-3 mb-3">Cetak Absen <i
                    ...
                    <table class="tg table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="tg-3xi5">
                                    {{number_format((($item->p1 + $item->p2 + $item->p3 + $item->p4 + $item->p5 + $item->p6 + $item->p7 + $item->p8 + $item->p9 + $item->p10 + $item->p11 + $item->p12 + $item->p13 + $item->p14 + $item->p15 + $item->p16) / 32) * 100 , 2)}}%
                                </td>
                            </tr>
                            @empty
                            <tr>
